...
//        }
        ...
        ActionResult action = interactionManager.interactBlock(player, hand, hitResult); // method doesnt need the world parameter
...
//        }
        ...
        if (!onlyRotation) {
            BlockHitResult hitResult = new BlockHitResult(hitVec, opposite, neighbour, false);
            ActionResult action = interactionManager.interactBlock(player, hand, hitResult); // world isnt needed
